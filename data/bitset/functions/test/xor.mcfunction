...
# 0x0000 0014
data modify storage bitset.__temp__: __input__.high set value 20
# 0x0000 4E20
data modify storage bitset.__temp__: __input__.low set value 20000
data modify storage bitset.__temp__: __input__.type set value 64
function bitset:api/int2bitset
data modify storage bitset.__temp__: __input__.bitset2 set from storage bitset.__temp__: __output__.bitset

function bitset:api/xor
