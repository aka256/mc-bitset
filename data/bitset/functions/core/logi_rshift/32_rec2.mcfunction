#> bitset:core/logi_rshift/32_rec2
# @within bitset:core/rshift/*

data modify storage bitset.__temp__: __output__.bitset.data append from storage bitset.__temp__: __input__.bitset1.data[-32]
